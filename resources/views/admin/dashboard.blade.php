...
<div class="container-fluid">
  ...
  @if(Auth::user() && Auth::user()->role_id === 1)
  <div class="col-md-12">
    <a href="{{ route('news.create') }}" class="btn btn-primary btn-margin-right">Create Blog</a>
    <a href="{{ route('admin.news') }}" class="btn btn-success btn-margin-right">Publish Blog</a>
    <a href="{{ route('news.trash') }}" class="btn btn-danger btn-margin-right">Trashed Blogs</a>
