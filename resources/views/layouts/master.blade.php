            ...
            <nav class="nav-extended">
                ...
                <div class="nav-content blue darken-4">
                    <ul class="tabs tabs-transparent">
                        <li class="tab"><a href="#test1">About</a></li>
                        <!--li class="tab"><a href="#test2">Experiences</a></li-->
                        <li class="tab"><a href="#test3">Schedule</a></li>
                        <li class="tab"><a href="#test4">Gallery</a></li>
                    </ul>
                </div>
            </nav>
        </div>
