              ...
              <div class="row">
                <div class="col s12">
                  <div class="row">
                    ...
                    {!! Form::open(['route'=>'contactus.store', 'class' => 'col m8 offset-m2 s12']) !!}

                        <div class="input-field col s12 {{ $errors->has('name') ? 'has-error' : '' }}">
                        {!! Form::label('Name:') !!}
                        {!! Form::text('name', old('name'), ['class'=>'form-input']) !!}
                        <span class="text-danger">{{ $errors->first('name') }}</span>
                        </div>

                        <div class="input-field col s12 {{ $errors->has('email') ? 'has-error' : '' }}">
                        {!! Form::label('Email:') !!}
                        {!! Form::text('email', old('email'), ['class'=>'form-input']) !!}
                        ...
                        <div class="input-field col s12">
                        <button class="disabled btn btn-large cyan">Contact US!</button>
                        </div>
